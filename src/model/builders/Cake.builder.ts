...
export class CakeBuilder {
    ...
    build(): Cake {
        ...
        if (!allFieldsSet) {
            logger.error('All required fields must be set before building the Cake object.');
            throw new Error('All required fields must be set before building the Cake object.');
        }
